...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/debimajumdar/PycharmProjects/heartsite/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/debimajumdar/PycharmProjects/heartsite/venv/bin/deactivate.nu'
